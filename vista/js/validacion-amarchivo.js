...
//	var nombreArchivo = nombre.value;
//	var extension = nombreArchivo.toLowerCase();
...
archivo.addEventListener('change', function(){
	...
	var posibarra = archivo.value.lastIndexOf("\\")+1;
	nombre.value = nombreArchivo.substring(posibarra);
